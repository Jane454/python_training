...
class TestAddContact(unittest.TestCase):
    ...
    def fill_contact_page(self, wd, contact):
        # fill contact form
    ...
    def test_add_contact(self):
        ...
        self.fill_contact_page(wd, Contact(firstname="Pavel", middlename="Petrovich", lastname="Ivanov", nickname="Petro", photo="C:\\Temp\\temp.jpg", title="PP", company="Lenovo", address="Moscow", home = "911", mobile="89020203033", work="02", fax="01", email="petro@gmail.com", email2=" ", email3=" ", homepage=" ", bday="3", bmonth="January", byear="1990", aday="10", amonth="November", ayear="1999" ))
